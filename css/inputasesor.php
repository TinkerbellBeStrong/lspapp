...
while ($datamain = mysql_fetch_array($hasilmain))
{
   ...
   echo "<td><a href=\"".$_SERVER['PHP_SELF'].
        "?op=edit&iduser=".$datamain['id_user']."\"><img src=../images/edit.png>Edit</a> | <a href=\"".$_SERVER['PHP_SELF'].
        "?op=delete&iduser=".$datamain['id_user']."\"><img src=../images/delete.png>Hapus</a></td>";
   echo "</tr>";
   $no++;
}
   echo "</div>";
