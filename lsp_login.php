        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
            ...
            <div class="login-logo">
                  <a href="#"><img class="img-responsive" src="images/logolsp.png" width="150" height="150" alt="Company Logo" /></a>
                </div> 
                <hr />
                <div class="login-form">
              <form id="form_id" name="login" action="lsp_cek_login.php" method="post">
