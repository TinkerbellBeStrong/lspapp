...
?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="backupdata.php"><svg class="glyph stroked download"><use xlink:href="#stroked-download"/></svg> Backup data</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
<!--data nu baru -->
<form id="formContoh" method="post" action="backupsql2.php">
Proses Backup Database ...</br>
<font color=red>(Lama proses tergantung koneksi dan besaran database)</font></br>
    
                    <label class="control-label col-lg-4">Pilih data yang akan di backup</label>
                    <div class="col-lg-4">
                    <select name="nmtabel" id="nmtabel" class="validate[required] form-control">
					<option value='us'> Data User </option>                                	
					<option value='upload'> Apl1 </option>
					<option value='apl2'> Apl2 </option>
					<option value='uas'> Unit Asesi </option>
					<option value='pertanyaan'> Pertanyaan </option>
					<option value='kdsoal'> Kode Soal </option>
					<option value='opt'> Tabel Option </option>
					<option value='grade'> Grade </option>
					<option value='unit,tuk,mak4'> Data Pendukung</option>
						
                    </select>
                    </div>

<input id='gobutton' type='submit' value='Lanjutkan ' />
