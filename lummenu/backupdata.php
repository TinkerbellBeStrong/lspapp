...
<h3><strong>Proses Backup Dan Restore Database ...</br></strong></h3>
<?php
echo "<strong>Nama Database: ".$database."</strong></br>"; ?>

<form id="formContoh" method="post" action="prosesbackupa.php" target="_blank">
<?php
// menampilkan semua tabel dalam form
//echo "<form method='post' action='prosesbackup.php'>";
echo "<input type='submit' id='gobutton' name='submit' value='PROSES BACKUP'>";
echo "</form>";
?>    
</br>
<form id="formContoh" method="post" action="prosesrestorea.php" target="_blank" onSubmit="return confirm('Apakah Yakin akan restore data?');">
<?php
// menampilkan semua tabel dalam form
//echo "<form method='post' action='prosesbackup.php'>";
echo "<input type='submit' id='gobutton' name='submit' value='PROSES RESTORE'>";
echo "</form>";
?> 
