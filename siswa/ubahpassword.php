...
?>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="ubahpassword.php"><svg class="glyph stroked key "><use xlink:href="#stroked-key"/></svg>Ubah Password</a></li>
			<li class="parent ">				
 ...
 if ($op=="postubahpass"){
  ...
  // echo "siap".  $passu;  
		...
		$sqlup="UPDATE lsp_usertbl SET password='$pass1' where id_user='$iduser'";
                ...
                if($suks) 
		{ echo " Perubahan Sukses ...Silahkan Logout";}
		else { echo "gagal....";} 
  }
...
<form id="formContoh" method="POST" <?php echo "action=\"".$_SERVER['PHP_SELF'].
        "?op=postubahpass\"";?> onSubmit="return confirm('Yakin akan di simpan ??')"> 

<?php 
$editpass="SELECT * FROM lsp_usertbl WHERE email='".$uname."'";
...
//echo $editpass;	
	...
	<input type=hidden name=iduser value='$rpass[id_user]'>
		...
		<table class=demo-table  width=60%>
               
                <th colspan=2><h4><strong>Ubah Password</strong></h4></th>
		<tr><td>Nama Asesi </td><td>: $namap </td></tr>		
		<tr><td>Password</td><td>:
		<input type=text name=passwordubah> * </td></tr>
		<tr><td>RePassword</td><td>:
		<input type=text name=repasswordubah> * </td></tr>
		
		<tr><td colspan=2>*)Apabila tidak diubah, dikosongkan saja</td></tr>
		<tr><td colspan=2>
                <input id=gobutton name=dsubmit type=submit value=Simpan>
		</td></tr>
	</table>
	</form></div>";
